...
<main style="min-height: 70vh;">
	...
	<div class="container position-relative">
		<div class="row g-4 align-items-center">
			<div class="col-md-6">
				<!-- Title -->
				<h1>{{ __('messages.industries') }} {{ __('messages.in') }} {{ __('messages.sealban') }}</h1>
				<p>{{ __('messages.industryP') }}</p>
			</div>

			<div class="col-md-6 text-center">
				<!-- Image -->
				<img src="{{asset('assets/images/solar-industries.png')}}" class="h-400px h-xl-500px" alt="">
			</div>
		</div>
	</div>
</section>
			...
			@foreach ($blogs as $blog)
				...
				<div class="col-sm-6 col-lg-4 col-xl-4">
					<div class="card bg-transparent">
						...
						<div class="card-body">
							<!-- Title -->
							<h5 class="card-title fw-normal"><a href="{{route('industry_detail', ['id'=>$blog->id])}}">{{$blog->title}}</a></h5>
							<!-- Info -->
							<div class="d-flex justify-content-between">
								<h6 class="mb-0 fw-normal"><a href="{{route('industry_detail', ['id'=>$blog->id])}}">{{ __('messages.sealban') }}</a></h6>
								<span class="small">
								    @if(app()->getLocale() == 'fa')

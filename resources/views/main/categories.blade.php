					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<div class="position-relative">
								<!-- Image -->
								<a href="@if($category->cat==1){{'/product/'.$category->id}}@else{{'/categories/'.$category->id}}@endif">
								    <img src="/storage/{{$category->image}}" style="height: 270px;" class="card-img-top" alt="book image">
								</a>
							</div>
							...
							<div class="card-footer px-3">
								<div class="d-flex justify-content-between align-items-center">
									<a href="@if($category->cat==1){{'/product/'.$category->id}}@else{{'/categories/'.$category->id}}@endif"><span class="h6 fw-light mb-0">{{$category->name}}</span></a>
								</div>
							</div>
						</div>
					</div>

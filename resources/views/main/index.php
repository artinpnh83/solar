    ...
    Main Banner START -->
        <section class="position-relative overflow-hidden pt-5 pt-lg-3">
            ...
            <div class="container">
                ...
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-lg-7 col-xl-6 text-center position-relative">
                        ...
                        <div class="position-relative">
                            <!--<img src="/storage/home/06.png" alt="">-->
                ...
                <div class="row align-items-center g-5 mt-5" style="justify-content: space-between;">
            ...
            <div class="container">
                <div class="row g-md-5 align-items-center">
                    ...
                    <div class="col-lg-6 mt-5 mt-lg-0">
                        ...
                        <p style="font-weight:100">About Sealban</p>
                        <!-- Content -->
                        <div class="row g-4">
                            <!-- Item -->
                            <div class="col-12">
                                ...
                                <div>
                                    <div class="card shadow h-100">
                                        ...
                                        <div class="card-body pb-0">
                                            ...
                                            <p class="mb-2 text-truncate-2" style="height: 45px;">{!! mb_substr(strip_tags($product->features), 0, 82) !!}
                                ...
                                <div class="col-11 mx-auto position-relative">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-7">
                                            ...
                                            <p class="text-white0 mb-3 mb-lg-0">{{ __('messages.box_index') }}</p>
                                        </div>
        ...
        <div id="ourfleet" class=" mt-3 direc row col-12 justify-content-end m-0 p-0 "
            ...
            <div class=" fleet col-lg-6 py-4 d-flex px-xl-5 txt-1" style="align-items: center;justify-content: center;">
                <div class="card ourfleet m-0 mb-1 mt-3 mt-md-0">
                    ...
                    <p class="py-md-4 px-xl-5 p-0 fleettxt card-text " style="COLOR: #7e7e7e;text-align-last: center;">
                ...
                <div class="row mb-4">
                    <div class="col-lg-8 mx-auto text-center">
                        ...
                        {{ __('messages.ser2_index') }}
                            <a href="/products">{{ __('messages.ser3_index') }}</a>
                                ...
                                <div>
                                    <div class="card shadow h-100">
                                        ...
                                        <div class="card-body pb-0">
                                            ...
                                            <p class="mb-2 text-truncate-2" style="height: 45px;">{!! mb_substr(strip_tags($service->short_des), 0, 82) !!}

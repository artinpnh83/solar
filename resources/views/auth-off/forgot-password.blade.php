				...
				<div class="col-12 col-lg-6 m-auto">
					<div class="row my-5">
						<div class="col-sm-10 col-xl-8 m-auto">
                            ...
                            @endif
							<!-- Title -->
							<h2 class="">{{ __('messages.forgotpassword') }}</h2>
						
							<!-- Form START -->
							<form action="{{route('user.forget.submit')}}" method="post">
							    @csrf
								<!-- Email -->
								<div class="mb-4">
									...
									<div class="input-group input-group-lg">
										...
										<input type="email" name="email" class="form-control border-0 bg-light rounded-end ps-1" value="{{old('email')}}" maxlength="50" placeholder="***@gmail.com" id="exampleInputEmail1">
									</div>
									@if($errors->has('email'))
								...
								<div class="align-items-center mt-0">
									<div class="d-grid">
										<button class="btn btn-primary mb-0" type="submit">{{ __('messages.send') }}</button>
									</div>
								</div>
							</form>
							<!-- Form END -->

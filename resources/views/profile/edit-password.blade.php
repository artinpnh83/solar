			...
			<div class="col-xl-3">
				...
				<div class="offcanvas-xl offcanvas-end" tabindex="-1" id="offcanvasSidebar">
					...
					<div class="offcanvas-header bg-light">
						<h5 class="offcanvas-title" id="offcanvasNavbarLabel">{{ __('messages.change_password') }}</h5>
			...
			<div class="col-xl-9">
				...
				<div class="card bg-transparent border rounded-3">
					...
					<div class="card-header bg-transparent border-bottom">
						<h3 class="card-header-title mb-0 ff-vb fs-5">{{ __('messages.change_password') }}</h3>
					</div>
					<!-- Card body START -->
					<div class="card-body">
						<!-- Form -->
						@if (\Session::has('error'))
                            ...
                            @endif
						<form class="row g-4" action="{{route('update-password')}}" method="post">
                        @csrf
							    <div class="mb-3">
